...
namespace vente
{
    public class EmailService : IIdentityMessageService
    {
        ...
        public Task SendAsync(IdentityMessage message)
        {
            ...
            client.Credentials = new NetworkCredential("haniyac1@gmail.com","15947823");
            MailMessage gm = new MailMessage();
            gm.IsBodyHtml = true;
            gm.Body = message.Body;
            gm.Subject = message.Subject;
            return client.SendMailAsync("haniyac1@gmail.com",
                                        message.Destination,
                                        gm.Subject,
                                        gm.Body);    
        }
